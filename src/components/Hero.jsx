...
const Hero = () => {
    return (
        <section className="relative min-h-screen w-full flex flex-col justify-center px-6 pt-20 overflow-hidden" id="home">
                ...
                <div className="col-span-1 lg:col-span-8 flex flex-col items-start z-20">
                    ...
                    >
                        ...
                        <span className="font-body text-xs md:text-sm tracking-[0.2em] text-navy/70 uppercase font-bold">
                            A Robotic & Research Lab | A.I. & Coding
                        </span>
                    </motion.div>
                    ...
                    <motion.h1
                        ...
                        className="text-[11vw] md:text-[8vw] leading-[0.9] font-display font-black text-navy mix-blend-darken -ml-1 md:-ml-4 tracking-tighter"
                    >
                        EMPOWERING <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-navy via-accent-blue to-purple-600">SCHOOLS.</span> <br />
                        <span className="text-[8vw] md:text-[6vw]">Building the Future.</span>
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="mt-6 text-lg md:text-xl font-display italic text-navy/60 max-w-2xl"
                    >
                    ...
                    >
                        <a
                            href="#courses"
                            className="group relative px-8 py-4 bg-navy text-silver rounded-full font-body font-bold text-sm tracking-wider overflow-hidden hover:bg-accent-blue transition-all duration-300 hover:scale-105 hover:shadow-xl"
                        >
                        ...
                        <div className="flex items-center gap-4 bg-white/50 backdrop-blur-sm p-2 pr-6 rounded-full border border-navy/10">
                            ...
                            <div className="flex flex-col">
                                <span className="font-display font-bold text-sm leading-none">+62k</span>
